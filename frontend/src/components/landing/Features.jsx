			...
			>
				...
				>
					...
					>
						...
						Whether you want to video chat, text chat or even post
						to the beaver feed,
						<chakra.span
							letterSpacing={"tight"}
							bgGradient={"linear(to-tl, brand.600, brand.400)"}
			...
			>
						...
						<Box order={{ base: "initial", md: 2 }}>
							<Box ref={ref2}>
								...
								<chakra.p
									...
									fontSize={{ md: "lg" }}
								>
									Join any of our chat lobbies to get matched
									with a fellow beaver. You can choose to join
									a video or text lobby. Keep in mind that
									activity may vary depending on the time of
									day.
								</chakra.p>
								<Button
									w={{ base: "full", sm: "auto" }}
				...
				>
						...
						<Box order={{ base: "initial", md: 1 }}>
							<Box ref={ref3}>
								...
								<chakra.p
									...
									fontSize={{ md: "lg" }}
								>
									Be it text or video chat, you will get
									matched to a random beaver for real-time
									synchronous conversation. If a beaver is not
									following the rules, immediately report them{" "}
									<chakra.a
					...
					<Image
						...
						objectFit="cover"
						src={
							colorMode === "light" ? textChatLight : textChatDark
						}
					/>
				</SimpleGrid>
			</Box>
