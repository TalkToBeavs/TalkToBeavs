        ...
        >
          ...
          >
            ...
            >
              ...
              <chakra.span bgGradient={'linear(to-tl, brand.600, brand.400)'} bgClip='text'>
            ...
            >
              By now, we all know Omegle had suspiscious users, inappropriate content, and a lack of
              features. We're here to change that.
            </chakra.p>
          </Box>
            ...
            >
              {offeringsData.map((offering, idx) => (
                <motion.div variants={item}>
                  <Offering key={idx} title={offering.title} icon={offering.icon}>
