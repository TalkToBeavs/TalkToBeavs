  ...
  return (
    <>
      ...
      >
        ...
        >
          <motion.div variants={videoChatVariant} initial='hidden' animate='visible'>
            <Heading
              as='h1'
              pb={2}
              size={{
          ...
          <motion.div variants={reImaginedVariant} initial='hidden' animate='visible'>
            <Heading
              as='h1'
              size={{
                base: '3xl',
          ...
          <motion.div variants={descriptionVariant} initial='hidden' animate='visible'>
            <Text
              mb={8}
              fontSize={{
                base: 'md',
            ...
            >
              TalkToBeavs opens the door to real-time video and text connections between{' '}
              <chakra.span
                letterSpacing={'tight'}
                bgGradient={'linear(to-tl, brand.600, brand.400)'}
                bgClip='text'
              ...
              , making every conversation on our platform an unforgettable experience.
            </Text>
          </motion.div>
