...
export const loadUserData = createAsyncThunk(
  ...
  async (email, { rejectWithValue }) => {
    try {
      const response = await axios.get(`https://https://talk-to-beavs.herokuapp.com/api/auth/load_user?email=${email}`);
...
export const registerUser = createAsyncThunk(
  ...
  async (values, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://https://talk-to-beavs.herokuapp.com/api/auth/register', values);
      return response.data;
    } catch (err) {
      return rejectWithValue(err.response.data);
    }
...
export const followUser = createAsyncThunk('user/follow', async (values, { rejectWithValue }) => {
  try {
    const response = await axios.post('https://https://talk-to-beavs.herokuapp.com/api/social/follow_user', values);
    return response.data;
  } catch (err) {
    return rejectWithValue(err.response.data);
  }
